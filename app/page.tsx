...
export default function FHLPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 p-4 md:p-10 text-slate-800 relative">
      ...
      {/* Botón WhatsApp */}
      <a href="https://wa.me/5491128694562?text=Hola%20FHL%20Filtros!" target="_blank" rel="noopener noreferrer" className="fixed bottom-8 right-8 bg-[#25d366] text-white p-4 rounded-full shadow-lg hover:scale-110 transition-transform z-50">
